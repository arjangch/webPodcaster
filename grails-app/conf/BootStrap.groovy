...
class BootStrap {
    ...
    def init = { servletContext ->
        new Podcasts(name: 'CNET', url: 'http://feeds.feedburner.com/cnet/allhdpodcast?format=xml').save(failOnError: true)  
        ...
        new Podcasts(name: 'Nasa jet', url: 'http://www.jpl.nasa.gov/multimedia/rss/podfeed-hd.xml').save(failOnError: true)
